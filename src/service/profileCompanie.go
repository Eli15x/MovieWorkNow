...
type CommandProfileCompanie interface {
	CreateNewProfileCompanie(ctx context.Context, name string, email string, password string) error
	AddInformationProfileCompanie(ctx context.Context, id string, job []string, message string) error
	GetInformationProfileCompanie(ctx context.Context, id string) ([]bson.M, error)
}
...
func (p *profileCompanie) CreateNewProfileCompanie(ctx context.Context, name string, email string, password string) error {
...
func (p *profileCompanie) AddInformationProfileCompanie(ctx context.Context, companieId string, job []string, message string) error {
...
func (p *profileCompanie) GetInformationProfileCompanie(ctx context.Context, id string) ([]bson.M, error) {
